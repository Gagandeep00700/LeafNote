...
import Modal from 'react-modal'; // Capitalized "Modal" to match usage in JSX
import { useNavigate } from "react-router-dom";
import axiosInstance from "../../utils/axiosInstance";
import EmptyCard from '../../components/EmptyCard/EmptyCard';

// Bind modal to your app element for accessibility (prevents screen readers from seeing background content)
      ...
      <div className="relative z-10">
        ...
        <div className="w-full px-3 sm:px-6 lg:px-8 py-4 sm:py-10 max-w-screen-xl mx-auto">
          <div className="mb-4 sm:mb-10">
            ...
            <div className="h-1 w-16 sm:w-24 bg-gradient-to-r from-green-600 via-emerald-500 to-green-500 rounded-full mt-2 shadow-lg shadow-green-500/20" />
          </div>
          ...
          {isLoading ? (
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="bg-gradient-to-br from-green-50 via-white to-emerald-50 backdrop-blur-xl p-4 sm:p-8 rounded-2xl shadow-2xl border border-green-200 hover:border-green-300 transition-all duration-200"
            >
              <EmptyCard
                message={
                  isSearch
