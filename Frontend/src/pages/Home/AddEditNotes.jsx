...
const AddEditNotes = ({ noteData, type, getAllNotes, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <motion.button
        className="btn-primary font-medium mt-4 sm:mt-5 p-2 sm:p-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 rounded-lg shadow-md w-full cursor-pointer text-white flex items-center justify-center"
