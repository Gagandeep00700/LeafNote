...
const Password = ({ value, onChange, placeholder = "Password" }) => {
  ...
  return (
    <div className="flex items-center border border-[#16A34A]/40 px-4 py-2 rounded-md focus-within:border-[#16A34A] transition-all duration-200 mb-3 bg-white shadow-sm"
    >
      <input
